...
def control_drone_thread():
    # print("Drone Control Activated: Use the following keys:")
    ...
    while True:
        try:
            ...
            elif keyboard.is_pressed('u'):  # Move Up
                print("Ascending...")
                if tello_connected:
                    tello.move_up(30)
                time.sleep(0.2)

            elif keyboard.is_pressed('j'):  # Move Down
                print("Descending...")
                if tello_connected:
                    tello.move_down(30)
                time.sleep(0.2)

            elif keyboard.is_pressed('h'):  # Rotate Left
                print("Rotating left...")
                if tello_connected:
                    tello.rotate_counter_clockwise(30)
                time.sleep(0.2)

            elif keyboard.is_pressed('n'):  # Rotate Right
            ...
            print(f"Error during drone control: {e}")
...
if __name__ == "__main__":
    ...
    if mode == 'tello':
        ...
        control_thread = threading.Thread(target=control_drone_thread, daemon=True)
